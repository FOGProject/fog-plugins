...
/**
 * Enough of FOGController for the model's class body to exist.
 */
class FOGController
{
    /**
    ...
    /**
     * Never reached: every assertion below stops before the write.
     *
     * @return bool
     */
...
/**
 * Enough of FOGManagerController for the manager's class body to exist.
 */
...
/**
 * Captures what the manager asks for instead of building SQL.
 */
class Schema
{
    /**
